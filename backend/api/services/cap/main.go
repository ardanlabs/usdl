...
import (
	...
	"github.com/ardanlabs/usdl/backend/app/sdk/mux"
	"github.com/ardanlabs/usdl/backend/business/chatbus"
	"github.com/ardanlabs/usdl/backend/business/chatbus/storage/usermem"
...
func run(ctx context.Context, log *logger.Logger) error {
	...
	cfg := struct {
		...
		NATS struct {
			...
			IDFilePath string `conf:"default:backend/zarf/cap"`
		}
	}{
